...
class State:
    def __init__(self, state=START):
        ...
        for i in range(0,BOARD_ROWS):
            for j in range(0, BOARD_ROWS):
                if str.isnumeric(BOARD[i][j]) or BOARD[i][j].startswith('-') and BOARD[i][j][1:].isdigit():
...
class Agent:
    ...
    def __init__(self, board):
        ...
        print(BOARD_COLS)
        BOARD = board
        self.BOARD_OUT = [['0']*BOARD_COLS]*BOARD_ROWS
        ...
        #result of agemt test, used for output
        #resultBoard =
    ...
    def play(self, rounds=10):
        ...
        while i < rounds:
            ...
            if self.State.isEnd:
                ...
                print("Directions")
                for i2 in self.states:
                    print(i2)
                print("\n Board")
                print(self.State.showBoard());
                print("Direction board")
                dispBoard(self.BOARD_OUT)
